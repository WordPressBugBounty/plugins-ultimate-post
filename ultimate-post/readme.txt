...
== Changelog ==
= 5.0.39 – 09 September 2026 =
* Fix: Minor bug fixes and performance improved.

= 5.0.38 – 30 August 2026 =
* Fix: Advanced Filter block current post ID detection issue causing incorrect filtering inside Query Loop and Builder templates

= 5.0.37 – 27 August 2026 =
* Fix: Undefined data type error in block editor when saving widget blocks
...
* Fix: Builder panel now scrolls to top on navigation
* Fix: Range field issue in the dashboard settings
* Fix: Add-ons toggle menu visibility
* Fix: Plugin page broken design fix

= 5.0.34 – 22 July 2026 =
* Fix: Infinite loop issue fixed for Post List 2 block
* Fix: Infinite loop issue fixed for Post List 3 block
* Fix: Infinite loop issue fixed for Post List 4 block

= 5.0.33 – 19 July 2026 =
* Fix: Improved HTML attribute escaping in the PostX Search block for enhanced security and WordPress coding standards compliance.

= 5.0.32 – 07 July 2026 =
* Fix: Post grid 7 Css issue 

= 5.0.31 – 01 July 2026 =
* Fix: Dashboard responsive issue
* Fix: WordPress submenu license routing issue
...
= 5.0.28 – 22 June 2026 =
* Fix: Dashboard user experience updated

= 5.0.27 – 18 June 2026 =
* Fix: Dashboard banner updated
...
= 5.0.23 – 04 June 2026 =
* Fix: Tab block caret issue
* Fix: Row block sticky issue
* Fix: Post block title EM unit issue
* Fix: WordPress 7 compatibility issue
* Fix: Advanced Filter translation issue
* Fix: Button block layout 4 gradient issue
* Fix: Post Slider title link issue (Layouts 1 & 2)
* Fix: Taxonomy block layout 3 background color issue

= 5.0.22 – 18 May 2026 =
* Fix: Advanced filter & Saved template compatibility issue
